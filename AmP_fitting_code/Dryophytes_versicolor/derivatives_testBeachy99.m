...
function [dX] = derivatives_testBeachy99(t, X, par)
    ...
    if EH >= par.EHb && EH <par.EHj
        kap = par.kap2;%kappa_function(EH,par.kap, par.kap2, par.EHb, par.EHj); % this might be a redundant function. Code to be rearranged
    end
