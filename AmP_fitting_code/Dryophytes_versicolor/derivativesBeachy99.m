...
%
% file derivativesBeachy99.m containing all the derivatives
% this file is needed to adapt to the specificities of the 
% experimental design in Beachy et al. 1999
function dX = derivativesBeachy99(t, X, par)
    ...
    % function to make sure that we have the right f factor at 
    % different times according to the experimental design
    par.f = timefeeding(t,par.f(1), par.f(2), par.switch);
